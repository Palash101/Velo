...
export default class Calendar extends PureComponent {
  ...
  render() {
    ...
    this.state.lastmonth = moment(this.state.dates[this.state.dates.length - 1]).format('MMMM');

    console.log(this.state.currentMonth,this.state.lastmonth)
